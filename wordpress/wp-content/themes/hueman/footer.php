			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half last">	
						...
						<form method="post" onsubmit="return newsletter_check(this)" action="http://webdev.livingutopia.org/wp-content/plugins/newsletter/do/subscribe.php"><input type="hidden" value="widget" name="nr"><input type="email" placeholder="Newsletter abonnieren" value="" name="ne" required="" class="newsletter-email"><input type="submit" value="&#xf0a9;" class="newsletter-submit"></form>
						<div style="clear:both;"></div>
